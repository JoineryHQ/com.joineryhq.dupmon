 ...
 */
class CRM_Dupmon_Upgrader_Base {

  /**
   * @var CRM_Dupmon_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Dupmon_Upgrader(
   ...
   *
   * ```
   * CRM_Dupmon_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Dupmon_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
