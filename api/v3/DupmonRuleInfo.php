...
/**
 * DupmonRuleInfo.create API specification (optional).
 ...
 */
function _civicrm_api3_dupmon_rule_info_create_spec(&$spec) {
  // $spec['some_parameter']['api.required'] = 1;
}

/**
 * DupmonRuleInfo.create API.
 *
 * @param array $params
 *
 * @return array
